...
**Live:** [https://relaxed-weasel-superset.cloud.nexlayer.ai](https://relaxed-weasel-superset.cloud.nexlayer.ai)  
...
**superset** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/apache/superset:latest
    path: /
    servicePorts:
    - 8088
    vars:
      SUPERSET_SECRET_KEY: "a1b2c3d4e5f6a1b2c3d4e5f6"
      DATABASE_URL: "postgresql+psycopg2://superset:superset@postgres.pod:5432/superset"
